...
// in C for boolean variables. For convenience, the ES API defines an 'int'.
...
{
    long    lMeasTime;
    int bUseADM;                               // Caution: has no effect in 6D mode and for AT4xx trackers !
};
...
struct GetCompensationsRT
{
    ...
    int               bHasMeasurementCameraMounted;      // Used for 6D systems
};
...
struct GetCompensations2RT
{
    ...
    int               bHasMeasurementCameraMounted;      // Used for 6D systems
    int               bIsActive;                         // Will be used in this configuration
};
